// ==UserScript==
// @name           jQuery4Monkey1.4.2
// @namespace      Starrow
// @description    jQuery 1.4.2 available in GreaseMonkey without error
// @version        0.2
// @author         Starrow Pan
// @include        http://not.run.itself
// ==/UserScript==
...
(function(window, undefined){
    ...
    (function(){
        ...
        //avoid an error when imported by Greasemonkey, inspired by  thpickert and bogleg on http:
        //forum.jquery.com/topic/importing-jquery-1-4-1-into-greasemonkey-scripts-generates-an-error
 ...
 fcloseTag = function(all, front, tag){
    ...
    var jsc = now(), rscript = /<script(.|\s)*?\/script>/gi, rselectTextarea = /select|textarea/i, rinput = /color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week/i, jsre = /=\?(&|$)/, rquery = /\?/, rts = /(\?|&)_=.*?(&|$)/, rurl = /^(\w+:)?\/\/([^\/?#]+)/, r20 = /%20/g,    // Keep a copy of the old load method
